...
trait Search
{
    ...
    function searchClient($request,$institution)
    {
        ...
        foreach ($identities as $identityId => $identityAccounts) {
            ...
            $fullName = $identityAccounts[0]->firstname != null and  $identityAccounts[0]->lastname != null ? $identityAccounts[0]->firstname . ' ' . $identityAccounts[0]->lastname:$identityAccounts[0]->raison_sociale;
