...
class ClaimController extends ApiController
{
    ...
    public function index(Request $request)
    {
        ...
        $awaitingTreatment = $this->getAllClaim($request , 'assigned_to_unit', true);

        $toValidate = $this->getAllClaim($request , 'assigned_to_staff', true);

        $toMeasureSatisfaction = $this->getAllClaim($request , 'treated', true);
