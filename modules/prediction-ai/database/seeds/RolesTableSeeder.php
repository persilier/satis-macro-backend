...
namespace Satis2020\Currency\Database\Seeds;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_list = Permission::create(['name' => 'list-prediction-ai', 'guard_name' => 'api']);
        $permission_store = Permission::create(['name' => 'store-prediction-ai', 'guard_name' => 'api']);
        $permission_update = Permission::create(['name' => 'update-prediction-ai', 'guard_name' => 'api']);
        $permission_destroy = Permission::create(['name' => 'destroy-prediction-ai', 'guard_name' => 'api']);
        $permission_show = Permission::create(['name' => 'show-prediction-ai', 'guard_name' => 'api']);
