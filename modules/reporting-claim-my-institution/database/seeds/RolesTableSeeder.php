...
namespace Satis2020\ReportingClaimMyInstitution\Database\Seeds;
...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // create permissions
        $permission_list = Permission::create(['name' => 'list-reporting-claim-my-institution', 'guard_name' => 'api']);
