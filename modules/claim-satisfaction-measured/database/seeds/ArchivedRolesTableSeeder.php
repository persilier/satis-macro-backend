 ...
 */
class ArchivedRolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission_archived_list = Permission::create(['name' => 'list-claim-archived', 'guard_name' => 'api']);
        $permission_archived_show = Permission::create(['name' => 'show-claim-archived', 'guard_name' => 'api']);
