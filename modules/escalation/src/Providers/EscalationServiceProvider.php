...
/**
 * Class EscalationServiceProvider
 * @package Satis2020\Escalation\Providers
 */
class EscalationServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ . '/../../resources/views', 'Escalation');
    }
    ...
    {
        $this->loadTranslationsFrom(__DIR__ . '/../../resources/lang', 'Escalation');
    }
