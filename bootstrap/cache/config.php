<?php return array (
  ...
  array (
    ...
    'activity_model' => 'Satis2020\\ServicePackage\\Models\\Activity',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'eloquent',
        'model' => 'Satis2020\\ServicePackage\\Models\\User',
      ),
    ),
    'passwords' => 
    array (
  ...
  array (
    ...
    'redis' => 
    array (
      'client-from-my-institution' => 'phpredis',
      'options' => 
      array (
        'cluster' => 'redis',
        'prefix' => 'satis_database_',
      ),
      'default' => 
      array (
        'url' => NULL,
...
',
  ...
  array (
    ...
    'app_registration' => 
    array (
      'app_name' => 'Care - Rwanda',
      'url' => 'http://localhost:8000/api/incoming/mail',
      'mail_server' => 'smtp.gmail.com',
      'mail_server_username' => 'test@gmail.com',
      'mail_server_password' => '****',
      'mail_server_port' => '587',
      'app_login_url' => 'http://localhost:8000/api/auth',
      'app_login_params' => 
      array (
        'grant_type' => 'password',
        'client_id' => '*****************',
